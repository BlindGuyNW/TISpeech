...
{
    /// <summary>
    /// Base class for escape menu screens in the in-game pause menu.
    /// Each screen represents a menu (Main, Save, Load, Settings, Exit Confirmation)
    /// and provides navigation through its controls.
    /// </summary>
    public abstract class EscapeMenuScreenBase
    {
        /// <summary>
        /// Display name of the menu (e.g., "Escape Menu", "Save Game")
        /// </summary>
        ...
        public virtual void ActivateControl(int index)
        {
            ...
            control.Activate();
            MelonLogger.Msg($"EscapeMenu: Activated control: {control.Label}");
        }
